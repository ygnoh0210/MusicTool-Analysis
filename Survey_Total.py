...
def raw_load():
    global total_R
    total_R=pd.read_excel('./Data/ListeningSurvey_TotalCompare.xlsx')

def p_confirm():
    for i, key in enumerate(participants.keys()):
        tttemp=total_R[total_R['이름']==key]
...
# 1회기, 5회기 전체 data 
first_total=total_R[total_R['회기']=='1회차']
second_total=total_R[total_R['회기']=='2회차']
third_total=total_R[total_R['회기']=='3회차']
forth_total=total_R[total_R['회기']=='4회차']
fifth_total=total_R[total_R['회기']=='5회차']
